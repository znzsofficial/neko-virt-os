...
export const OPEN_SOURCE_PACKAGES: readonly OpenSourcePackage[] = [
  ...
  { name: "postprocessing", version: "6.39.4", license: "Zlib" },
  { name: "@yohawing/three-mmd-loader", version: "0.8.2", license: "MIT" },
  { name: "@fontsource-variable/noto-sans-sc", version: "5.3.0", license: "OFL-1.1", note: "Noto Sans SC by Google" },
  { name: "mediabunny", version: "1.55.1", license: "MPL-2.0" },
  { name: "zustand", version: "5.0.15", license: "MIT" },
  { name: "dexie", version: "4.4.5", license: "Apache-2.0" },
  { name: "zod", version: "4.4.3", license: "MIT" },
  { name: "marked", version: "18.0.9", license: "MIT" },
  ...
  { name: "nanoid", version: "6.0.1", license: "MIT" },
